...
namespace CorePersian
{
    public static class CultureInfoExtensions
    {
        ...
        public static System.Globalization.CultureInfo AddPersianCalendar(this System.Globalization.CultureInfo cultureInfo)
        {
            if (cultureInfo == null)
        ...
        /// <exception cref="System.ArgumentNullException">cultureInfo</exception>
        public static PersianCultureInfo ToPersianCultureInfo(this System.Globalization.CultureInfo cultureInfo)
        {
            if (cultureInfo == null)
                throw new ArgumentNullException(nameof(cultureInfo));
